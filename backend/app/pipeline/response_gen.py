...
async def generate_response(llm: LLMClient, context: CallContext, action_summary: str | None) -> str:
    ...
    system = (
        ...
        "nothing new is being asked or corrected, give ONE short natural goodbye and stop there — "
        "do not re-summarize the whole appointment again, and never repeat a line you already said "
